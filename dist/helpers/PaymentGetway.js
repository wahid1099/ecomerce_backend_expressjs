...
const initiatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield axios_1.default.post(index_1.default.payment_url, {
            ...
            success_url: `${index_1.default.backend_url}/api/payment/confirmation?transactionId=${payload.transactionId}&status=success&payloadData=${payloadData}`,
            fail_url: `${index_1.default.backend_url}/api/payment/confirmation?transactionId=${payload.transactionId}&status=failed`,
