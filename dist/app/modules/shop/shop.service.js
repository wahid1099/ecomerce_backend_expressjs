...
const updateShop = (shopId, vendorId, shopData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const shop = yield shop_model_1.Shop.findOneAndUpdate(
      { _id: shopId, vendorId },
      shopData,
      { new: true }
    );
...
const getVendorShops = (vendorId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const shops = yield shop_model_1.Shop.find({ vendorId });
    return shops;
  });
const deleteShop = (shopId, vendorId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const shop = yield shop_model_1.Shop.findOneAndDelete({
      _id: shopId,
      vendorId,
    });
    if (!shop) {
...
const getShopOrderHistory = (shopId, vendorId) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const followShop = (userId, shopId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isAlreadyFollowing = yield shop_model_1.ShopFollower.findOne({
      userId,
      shopId,
    });
...
const unfollowShop = (userId, shopId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const followRecord = yield shop_model_1.ShopFollower.findOne({
      userId,
      shopId,
    });
    if (!followRecord) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return followers.map((follower) => {
      ...
      return {
        ...
        email:
          (_c = follower.user) === null || _c === void 0 ? void 0 : _c.email,
        profileImage:
          (_d = follower.user) === null || _d === void 0
            ? void 0
            : _d.profileImage,
      };
    });
