...
const inserUserIntoDB = (0, catchAsync_1.default)((req, res) =>
...
const getAllUsersfromDb = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getMyprofilefromDb = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateUserIntoDb = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const suspendVendor = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_service_1.UserService.suspendVendor(
      vendorId,
      isSuspended
    );
    (0, sendResponse_1.default)(res, {
...
const getUserFollowedShops = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id; // Assuming user ID is in the request
    const result = yield user_service_1.UserService.getUserFollowedShops(
      userId
    );
